...
resource "aws_iam_role" "aws_cyi_infrastructure_emr_service" {
...
#   role       = aws_iam_role.aws_cyi_infrastructure_emr_service.name
...
resource "aws_iam_role_policy_attachment" "aws_cyi_infrastructure_emr_service_ebs_cmk" {
  role       = aws_iam_role.aws_cyi_infrastructure_emr_service.name
